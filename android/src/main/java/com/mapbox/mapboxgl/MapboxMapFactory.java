...
public class MapboxMapFactory extends PlatformViewFactory {
    ...
    public PlatformView create(Context context, int id, Object args) {
        ...
        //register plugins
        MapPluginsManager.INSTANCE.registerBuilder(id, new HeavenMapBuilder().interpretOptions(params.get("plugins-options")));
        MapPluginsManager.INSTANCE.registerBuilder(id, new MapRouteBuilder().interpretOptions(params.get("plugins-options")));
        MapPluginsManager.INSTANCE.buildPlugins(id);
