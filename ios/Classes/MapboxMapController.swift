...
class MapboxMapController: NSObject {
...
extension MapboxMapController: MGLMapViewDelegate {
    /*
     *  MGLMapViewDelegate
     */
    func mapView(_ mapView: MGLMapView, didFinishLoading style: MGLStyle) {
        ...
        print("[MapboxController] --> url: \(style)")
...
// MARK: MapboxMapOptionsSink
extension MapboxMapController: MapboxMapOptionsSink {
...
extension MapboxMapController: FlutterPlatformView {
